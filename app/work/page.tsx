...
const roles: Role[] = [
  {
    ...
    bullets: [
      ...
      'Produced live Confluence documentation and AWS architecture diagrams by reverse-engineering frontend, backend, and microservice interactions, clarifying inbound/outbound service flows and backend design patterns.',
      ...
      'Migrated legacy device communication from an MQTT-based messaging solution to AWS AppSync to enable real-time synchronisation and control across multiple digital signage displays.',
      'Implemented responsive layout support for portrait (1080×1920) and landscape (1920×1080) digital signage displays, ensuring consistent rendering across different screen orientations.',
      ...
      'Re-architecting the frontend codebase to centralise API call logic between layers and enable stricter TypeScript typings on domain and API-related data structures.',
      'Investigating dev/staging AWS environment infrastructure and cost to brainstorm optimisation strategies.',
    ],
  },
  {
    ...
    bullets: [
      'Architected and delivered a production-grade lab automation system integrating real-time telemetry, firmware control, and secure user authentication, transforming a traditionally manual experimental workflow into a safe, automated and traceable research platform used by 15–20 active scientists.',
      ...
      'Designed a scalable firmware abstraction layer bridging UI → server → firmware → Modbus hardware, replacing rigid single hardware bindings with configuration-driven patterns to support evolving multi-column setups.',
      'Redesigned and normalised the relational database schema to accurately model experiment lifecycles, user roles, and audit-ready comment versioning, improving data integrity, traceability, and extensibility.',
      ...
      'Implemented safe, correct lock mechanisms to prevent multithread access to the hardware and firmware-level caching to minimise hardware interference, contributing to stable three-month continuous production operation.',
      'Improved system reliability by refining API design, introducing structured logging and defensive error handling across the full stack.',
      'Implemented Azure Entra ID SSO and middleware-based role authorisation to enforce secure access control across the application.',
      ...
      'Led domain analysis and mobile-first redesign for the DC.CoP® application by translating Voice of Customer insights into a Figma → React Native prototype aligned with refinery operator workflows.',
      ...
      'Applied end-to-end SDLC practices including requirements analysis, iterative prototyping, Jira-based task tracking, Git version control, formal documentation, and knowledge transfer.',
      'Led technical demonstrations for internal leadership, visiting industry partners, and national intern cohorts, communicating architectural decisions and the strategic value of applied software engineering.',
    ],
  },
]
